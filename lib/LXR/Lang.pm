...
#
# $Id: Lang.pm,v 1.41 2012/02/10 20:54:30 ajlittoz Exp $
...
$CVSID = '$Id: Lang.pm,v 1.41 2012/02/10 20:54:30 ajlittoz Exp $ ';
...
sub processstring {
	...
	$$frag =~ s!\n!</span>\n<span class="string">!g;
	$$frag =~ s!<span class="string"></span>$!! ; #remove excess marking
}

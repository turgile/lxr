# -*- tab-width: 4 -*- ###############################################
#
# $Id: Generic.pm,v 1.33 2012/04/17 08:10:46 ajlittoz Exp $
#
...
$CVSID = '$Id: Generic.pm,v 1.33 2012/04/17 08:10:46 ajlittoz Exp $ ';
...
sub referencefile {
	...
	&LXR::SimpleParse::init(FileHandle($path)->new(), 1, $self->parsespec);
